...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=xlcd/readdata.c xlcd/setcgram.c xlcd/writdata.c xlcd/wcmdxlcd.c xlcd/putrxlcd.c xlcd/busyxlcd.c xlcd/setddram.c xlcd/readaddr.c xlcd/openxlcd.c xlcd/putsxlcd.c xlcd/HeartRateSpeaker.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/xlcd/readdata.o ${OBJECTDIR}/xlcd/setcgram.o ${OBJECTDIR}/xlcd/writdata.o ${OBJECTDIR}/xlcd/wcmdxlcd.o ${OBJECTDIR}/xlcd/putrxlcd.o ${OBJECTDIR}/xlcd/busyxlcd.o ${OBJECTDIR}/xlcd/setddram.o ${OBJECTDIR}/xlcd/readaddr.o ${OBJECTDIR}/xlcd/openxlcd.o ${OBJECTDIR}/xlcd/putsxlcd.o ${OBJECTDIR}/xlcd/HeartRateSpeaker.o
POSSIBLE_DEPFILES=${OBJECTDIR}/xlcd/readdata.o.d ${OBJECTDIR}/xlcd/setcgram.o.d ${OBJECTDIR}/xlcd/writdata.o.d ${OBJECTDIR}/xlcd/wcmdxlcd.o.d ${OBJECTDIR}/xlcd/putrxlcd.o.d ${OBJECTDIR}/xlcd/busyxlcd.o.d ${OBJECTDIR}/xlcd/setddram.o.d ${OBJECTDIR}/xlcd/readaddr.o.d ${OBJECTDIR}/xlcd/openxlcd.o.d ${OBJECTDIR}/xlcd/putsxlcd.o.d ${OBJECTDIR}/xlcd/HeartRateSpeaker.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/xlcd/readdata.o ${OBJECTDIR}/xlcd/setcgram.o ${OBJECTDIR}/xlcd/writdata.o ${OBJECTDIR}/xlcd/wcmdxlcd.o ${OBJECTDIR}/xlcd/putrxlcd.o ${OBJECTDIR}/xlcd/busyxlcd.o ${OBJECTDIR}/xlcd/setddram.o ${OBJECTDIR}/xlcd/readaddr.o ${OBJECTDIR}/xlcd/openxlcd.o ${OBJECTDIR}/xlcd/putsxlcd.o ${OBJECTDIR}/xlcd/HeartRateSpeaker.o

# Source Files
SOURCEFILES=xlcd/readdata.c xlcd/setcgram.c xlcd/writdata.c xlcd/wcmdxlcd.c xlcd/putrxlcd.c xlcd/busyxlcd.c xlcd/setddram.c xlcd/readaddr.c xlcd/openxlcd.c xlcd/putsxlcd.c xlcd/HeartRateSpeaker.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/xlcd/HeartRateSpeaker.o: xlcd/HeartRateSpeaker.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/xlcd" 
	@${RM} ${OBJECTDIR}/xlcd/HeartRateSpeaker.o.d 
	@${RM} ${OBJECTDIR}/xlcd/HeartRateSpeaker.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/xlcd/HeartRateSpeaker.o   xlcd/HeartRateSpeaker.c 
	@${DEP_GEN} -d ${OBJECTDIR}/xlcd/HeartRateSpeaker.o 
	@${FIXDEPS} "${OBJECTDIR}/xlcd/HeartRateSpeaker.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/xlcd/HeartRateSpeaker.o: xlcd/HeartRateSpeaker.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/xlcd/HeartRateSpeaker.o.d 
	@${RM} ${OBJECTDIR}/xlcd/HeartRateSpeaker.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/xlcd/HeartRateSpeaker.o   xlcd/HeartRateSpeaker.c 
	@${DEP_GEN} -d ${OBJECTDIR}/xlcd/HeartRateSpeaker.o 
	@${FIXDEPS} "${OBJECTDIR}/xlcd/HeartRateSpeaker.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_PK3=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}/../lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}/../lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/HeartRateSpeaker.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
